...
app.post("/getUserInfo", (req, res) => {
 ...
 app.get("/getAllComments/:postId", (req, res) => {
    ...
    let sqlForAllComments = `SELECT users.userName AS commentedUserName, users.userImage AS commentedUserImage, comments.commentId, 
    comments.commentOfPostId,comments.commentText, comments.commentTime
      FROM comments
